  ...
  async execute(message, args, client) {
    try {
        ...
        while (!raceFinished) {
          ...
          // Gửi tin nhắn dẫn đầu (Có thể spam kênh chat, cân nhắc xóa dòng này nếu muốn gọn)
        ...
        // --- SỬA LỖI Ở ĐÂY ---
        // Thêm 'await' vì processBetResults bây giờ tương tác với Database
        ...
        // Bây giờ betResults đã là mảng, vòng lặp sẽ chạy ok
        ...
        console.error('Lỗi trong lệnh race:', error);
        raceManager.setRaceStatus(false); // Reset trạng thái nếu lỗi để không bị kẹt
        return message.reply('Đã xảy ra lỗi trong quá trình đua!');
    }
  },
};
